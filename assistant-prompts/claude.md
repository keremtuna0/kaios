# KAIOS Startup Prompt — Claude

Use this prompt to load KAIOS into Claude (Claude.ai or Claude API).

## How To Load

### Option A: Project instructions (recommended for repeated use)

If your Claude plan supports Projects:

1. Create a project for your engineering work.
2. Add these files to project knowledge when available:
   - `versions/v0.1/PROMPT.md`
   - `versions/v0.1/CORE.md`
   - `QUICKSTART.md`
3. Paste the **KAIOS Core Prompt** below into the project custom instructions.

### Option B: First message in a new conversation
...
When using the Claude API, place the **KAIOS Core Prompt** in the system
parameter. Send the task in the first user message.
...
Copy everything below this line into Claude project instructions or your first
message.
...
- Do not behave as an autonomous agent or multi-agent orchestrator.
...
When project knowledge includes the KAIOS repository, follow module contracts
under `modules/` and templates under `contracts/`.
